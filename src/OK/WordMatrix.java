...
//                System.out.println("i vale: " + i + " j vale: " + j );
                if (search(matrix, word, i, j, 0, N)) {
                    System.out.println("i vale: " + i + " j vale: " + j + " index vale : " + 0 );
                    return true;
                }
            }
        }
    ...
    public boolean search(char[][] matrix, String word, int row, int col,
        ...
        System.out.println("[fila, col] " + row +","+col + " "+ word.charAt(index) +" comparado con "+ matrix[row][col]);


        //significa que ya comparé la ultima letra de la palabra y esta ok
